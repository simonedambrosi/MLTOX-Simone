...
def adding_smiles_features(dataframe):
    ...
    properties = pd.concat([pd.read_excel(open("C:/Users/Simone/Desktop/Utilità tesi magistrale/data/DSSToxQueryWPred1.xlsx", 'rb'), # here
                  usecols =  ['Substance_CASRN', 'NCCT_MP', 'NCCT_WS'], engine = 'openpyxl'),
                  pd.read_excel(open("C:/Users/Simone/Desktop/Utilità tesi magistrale/data/DSSToxQueryWPred2.xlsx", 'rb'), # here
                  usecols =  ['Substance_CASRN', 'NCCT_MP', 'NCCT_WS'], engine = 'openpyxl'),
                  pd.read_excel(open("C:/Users/Simone/Desktop/Utilità tesi magistrale/data/DSSToxQueryWPred3.xlsx", 'rb'), # here
                  usecols =  ['Substance_CASRN', 'NCCT_MP', 'NCCT_WS'], engine = 'openpyxl'),
                  pd.read_excel(open("C:/Users/Simone/Desktop/Utilità tesi magistrale/data//DSSToxQueryWPred4.xlsx", 'rb'), # here
